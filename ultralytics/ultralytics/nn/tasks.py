...
# for custom modules calling
import sys
import os
###################################
# Step 1: Add root path to PYTHONPATH so Python can find custom_modules
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
# sys.path.append("D:/Coding/New_folder/MRC/")
from custom_modules.sr_module import SRBlock
from custom_modules.spd_module import SPDModule
from custom_modules.ha_module import HybridAttention
########################################
import torch
...
def parse_model(d, ch, verbose=True):
    ...
    globals()['SPDModule'] = SPDModule
    globals()['SRBlock'] = SRBlock
    globals()['HybridAttention'] = HybridAttention
